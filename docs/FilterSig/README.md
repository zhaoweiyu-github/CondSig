...
CondSigDetector produces two separated summary tsv for promoter and non-promoter CondSigs. E.g., mESC_promoter_CondSigs.txt, mESC_nonpromoter_CondSigs.txt, and each summary tsv contains four columns:
